...
#    Updated: 2025/02/05 17:50:48 by anastruc         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = main.c parsing_metadata.c set_texture.c free_and_error.c parsing_utils.c check_for_texture_doublon.c check_for_color_doublon.c parse_map.c parsing_colors.c
