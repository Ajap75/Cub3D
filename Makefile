...
#    Updated: 2025/02/03 12:04:40 by anastruc         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = main.c parsing_metadata.c set_texture.c free_and_error.c parsing_utils.c check_for_texture_doublon.c check_for_color_doublon.c parse_map.c
